        ...
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            ...
            <form class="login100-form validate-form flex-sb flex-w">
                ...
                <div class="wrap-input100 validate-input m-b-36" data-validate="E-postanızı Giriniz">
                    <input class="input100" id="username" type="email" name="email">
                ...
                <div class="container-login100-form-btn">
                    <a onclick="giris(event)" class="login100-form-btn">Giriş Yap</a>
                </div>
            </form>
            <!-- form bitiş-->
        </div>
...
<script>
    giris = function(event) {
        event.target.style.display = "none";
        throwQuery("../api/login", {
